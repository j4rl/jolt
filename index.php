...
<section class="hero"><div><span class="eyebrow">JOLTA LIVE</span><h1>Släpp loss<br><em>energin.</em></h1><p>Gör, dela och tävla i Jolt som får hela rummet att vakna.</p><a class="studio-entry" href="<?=user_id()?'dashboard.php':'auth.php'?>"><span>Jolt Studio</span> Skapa och led en Jolt →</a></div>
