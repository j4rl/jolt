...
<nav><a class="logo" href="index.php">JOLT<span>⚡</span></a><div><?php if(user_id()): ?><a href="dashboard.php">Mina Jolt</a><a href="auth.php?logout=1">Logga ut</a><?php else: ?><a href="auth.php">Logga in</a><?php endif ?><a href="about.php">Om</a><ld-theme-toggle></ld-theme-toggle></div></nav><main>
<?php }
